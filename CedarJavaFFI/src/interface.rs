...
pub(crate) mod jvm_based_tests {
    ...
    mod policy_tests {
        ...
        fn policy_set_to_ast_internal_success_basic() {
            ...
            let parsed_jstring = JString::cast(&mut env, jvalue.l().unwrap()).unwrap();
            let actual_parsed_string = String::from(env.get_string(&parsed_jstring).unwrap());
            let expected_canonical_string = "[{ \"name\": \"policy0\", \"effect\": \"permit\", \"condition\": { \"type\": \"bool\", \"value\": true, \"source\": { \"offset\": 0, \"len\": 34 } }, \"source\": { \"offset\": 0, \"len\": 34 } }]";
        ...
        fn policy_set_to_ast_internal_success_multiple() {
            ...
            let parsed_jstring = JString::cast(&mut env, jvalue.l().unwrap()).unwrap();
            let actual_parsed_string = String::from(env.get_string(&parsed_jstring).unwrap());
            let expected_canonical_string = "[{ \"name\": \"policy0\", \"effect\": \"permit\", \"condition\": { \"type\": \"binary\", \"op\": \"and\", \"left\": { \"type\": \"bool\", \"value\": true }, \"right\": { \"type\": \"binary\", \"op\": \"and\", \"left\": { \"type\": \"bool\", \"value\": true }, \"right\": { \"type\": \"binary\", \"op\": \"and\", \"left\": { \"type\": \"bool\", \"value\": true }, \"right\": { \"type\": \"binary\", \"op\": \"eq\", \"left\": { \"type\": \"var\", \"ref\": \"principal\", \"source\": { \"offset\": 118, \"len\": 9 } }, \"right\": { \"type\": \"str\", \"value\": \"poppy\", \"quoted\": true, \"source\": { \"offset\": 131, \"len\": 7 } }, \"source\": { \"offset\": 118, \"len\": 20 } }, \"source\": { \"offset\": 0, \"len\": 141 } }, \"source\": { \"offset\": 0, \"len\": 141 } }, \"source\": { \"offset\": 0, \"len\": 141 } }, \"source\": { \"offset\": 0, \"len\": 141 } }, { \"name\": \"policy1\", \"effect\": \"forbid\", \"condition\": { \"type\": \"binary\", \"op\": \"and\", \"left\": { \"type\": \"bool\", \"value\": true }, \"right\": { \"type\": \"binary\", \"op\": \"and\", \"left\": { \"type\": \"bool\", \"value\": true }, \"right\": { \"type\": \"binary\", \"op\": \"and\", \"left\": { \"type\": \"bool\", \"value\": true }, \"right\": { \"type\": \"binary\", \"op\": \"eq\", \"left\": { \"type\": \"var\", \"ref\": \"action\", \"source\": { \"offset\": 273, \"len\": 6 } }, \"right\": { \"type\": \"str\", \"value\": \"murder\", \"quoted\": true, \"source\": { \"offset\": 283, \"len\": 8 } }, \"source\": { \"offset\": 273, \"len\": 18 } }, \"source\": { \"offset\": 155, \"len\": 139 } }, \"source\": { \"offset\": 155, \"len\": 139 } }, \"source\": { \"offset\": 155, \"len\": 139 } }, \"source\": { \"offset\": 155, \"len\": 139 } }]";
